...
cap = cv2.VideoCapture('/Users/gabrieltrindade/YOLOV8/yolov8parkingspace-main/parking1.mp4')

my_file = open("/Users/gabrieltrindade/YOLOV8/yolov8parkingspace-main/classes.txt", "r")
data = my_file.read()
