...
cap=cv2.VideoCapture('/Users/gabrieltrindade/Documents/YOLOV8/yolov8parkingspace-main/parking1.mp4')

my_file = open("/Users/gabrieltrindade/Documents/YOLOV8/yolov8parkingspace-main/coco.txt", "r")
data = my_file.read()
