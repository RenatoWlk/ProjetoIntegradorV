...
cap = cv2.VideoCapture('D:/Documents/ProjetoIntegradorV/YOLOV8/yolov8parkingspace-main/parking1.mp4')

# coco.txt
my_file = open("D:/Documents/ProjetoIntegradorV/YOLOV8/yolov8parkingspace-main/classes.txt", "r")
data = my_file.read()
